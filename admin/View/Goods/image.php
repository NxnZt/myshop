...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
				<tr>
					<td width="90%" align="left" valign="middle">
						<form method="post" action="GoodsController.php?cname=addimg" enctype="multipart/form-data">
							<span></span>
							<input type="hidden" name="goods_id" value="<?php echo $_GET['id']?>" class="text-word">
							<input type="file" name="pic" class="text-word">
							<input name="" type="submit" value="上传图片" class="text-but">
						</form>
					</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
				...
				<tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
					...
					<td align="center" valign="middle" class="borderright borderbottom">
						<img src="<?php echo __PUBLIC__.$val['image_url']; ?>" width="50" height="50"/>
					</td>
					<td align="center" valign="middle" class="borderright borderbottom">
						<a href="GoodsController.php?cname=delimg&gid=<?php echo  $val['goods_id'] ?>&id=<?php echo $val['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
					</td>
				</tr>
                <?php endforeach?>
				<?php endif ?>
	...
	<tr>
		<td align="left" valign="top" class="fenye"> 条数据 /页&nbsp;&nbsp;
