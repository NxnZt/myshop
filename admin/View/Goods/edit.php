...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="GoodsController.php?cname=edit" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
          ...
          <input type="text" name="goods_name" value="<?php echo $gData['goods_name']?>" class="text-word">
          </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <td align="right" valign="middle" class="borderright borderbottom bggray">商品价格：</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for">
              <input type="text" name="price" value="<?php echo $gData['price']?>" class="text-word">
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            ...
            <td align="left" valign="middle" class="borderright borderbottom main-for">
              ...
              <?php foreach($data as $v):?>
                <option value="<?php echo $v['id']?>" <?php echo $gData['cate_id']==$v['id']?'selected':'';?>><?php echo str_repeat('----',$v['space']).$v['catename']?></option>
              <?php endforeach;?>
              </select>
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            ...
            <td align="left" valign="middle" class="borderright borderbottom main-for">
              <input type="text" name="store" value="<?php echo $gData['store']?>" class="text-word">
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            ...
            <td align="left" valign="middle" class="borderright borderbottom main-for">
              ...
              <img src="<?php echo __PUBLIC__.$gData['goods_img']?>" alt="" width="50" height="50">
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <td align="right" valign="middle" class="borderright borderbottom bggray">是否热销</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for">
            <label><input type="radio" name="is_hot" value="0" <?php echo $gData['is_hot']==0?'checked':''?>>是</label>
            <label><input type="radio" name="is_hot" value="1" <?php echo $gData['is_hot']==1?'checked':''?>>否</label>
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <td align="right" valign="middle" class="borderright borderbottom bggray">是否新品</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for">
            <label><input type="radio" name="is_new" value="0" <?php echo $gData['is_new']==0?'checked':''?>>是</label>
            <label><input type="radio" name="is_new" value="1" <?php echo $gData['is_new']==1?'checked':''?>>否</label>
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <td align="right" valign="middle" class="borderright borderbottom bggray">是否精品</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for">
            <label><input type="radio" name="is_best" value="0" <?php echo $gData['is_hot']==0?'checked':''?>>是</label>
            <label><input type="radio" name="is_best" value="1" <?php echo $gData['is_hot']==1?'checked':''?>>否</label>
            </td>
          </tr>
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
