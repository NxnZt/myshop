  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom" style="padding-left:20px"> <?php echo str_repeat('--',$v['space']).$v['catename']?></td>
        <td align="center" valign="middle" class="borderbottom">
            <a href="CategaryController.php?cname=edit&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
            <a href="CategaryController.php?cname=del&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
    <?php endforeach;?>
    <?php endif;?>
    </table></td>
