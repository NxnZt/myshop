...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="CategaryController.php?cname=edit">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
        <input type="hidden" name="id" value="<?php echo $data[0]['id']?>">
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <td align="right" valign="middle" class="borderright borderbottom bggray">上级分类</td>
          <td align="left" valign="middle" class="borderright borderbottom main-for">
            <select name="pid" id="level">
               <option value="0">顶级分类</option>
               <?php foreach($catedata as $v):?>
                <option value="<?php echo $v['id']?>" <?php echo $data[0]['pid']==$v['id']?'selected':'';?>><?php echo str_repeat('--', $v['space']).$v['catename']?></option>
               <?php endforeach;?>
            </select>
          </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          ...
          <td align="left" valign="middle" class="borderright borderbottom main-for">
            <input type="text" name="catename" value="<?php echo $data[0]['catename']?>" class="text-word">
          </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
