...
#main div.top{ width:100%; background:url(<?php echo __PUBLIC__.'/Admin/Image/main/main_r2_c2.jpg';?>) no-repeat 0 10px; padding:0 0 0 15px; line-height:35px; float:left}
#main div.sec{ width:100%; background:url(<?php echo __PUBLIC__.'/Admin/Image/main/main_r2_c2.jpg';?>) no-repeat 0 15px; padding:0 0 0 15px; line-height:35px; float:left}
.left{ float:left}
#main div a{ float:left}
#main span.num{  font-size:30px; color:#538ec6; font-family:"Georgia","Tahoma","Arial";}
.left{ float:left}
div.main-tit{ font-size:14px; font-weight:bold; color:#4e4e4e; background:url(<?php echo __PUBLIC__.'/Admin/Image/main/main_r4_c2.jpg';?>) no-repeat 0 33px; width:100%; padding:30px 0 0 20px; float:left}
div.main-con{ width:100%; float:left; padding:10px 0 0 20px; line-height:36px;}
div.main-corpy{ font-size:14px; font-weight:bold; color:#4e4e4e; background:url(<?php echo __PUBLIC__.'/Admin/Image/main/main_r4_c2.jpg';?>) no-repeat 0 33px; width:100%; padding:30px 0 0 20px; float:left}
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <div class="top"><span class="left">您上次的登录时间：<?php echo date('Y-m-d H:i:s');?>  登录IP：<?php echo $_SERVER['SERVER_ADDR']?> &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.html" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
