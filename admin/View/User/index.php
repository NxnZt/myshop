    ...
    <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
         ...
         <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;">
            <a href="UserController.php?cname=add" target="mainFrame" onFocus="this.blur()" class="add">新增管理员</a>
         </td>
  		</tr>
	    </table>
    </td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $v['rank']==0?'超级管理员':($v['rank']==1?'一般管理员':'信息录入员')?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $v['sex']==0?'男':($v['sex']==1?'女':'保密')?></td>
        <td align="center" valign="middle" class="borderright borderbottom">
        <?php if($v['status']==0):?>
            <a href="UserController.php?cname=edit&id=<?php echo $v['id']?>&status=1">开启</a>
        <?php else:?>
            <a href="UserController.php?cname=edit&id=<?php echo $v['id']?>&status=0">锁定</a>
        <?php endif;?>
        </td>
        <td align="center" valign="middle" class="borderbottom">
            <a href="UserController.php?cname=edit&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
            <a href="UserController.php?cname=del&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
    <?php endforeach;?>
     <?php endif;?>
    </table></td>
