        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="get" action="WebWebUserController.php">
	            <span>管理员：</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $v['sex']==0?'男':($v['sex']==1?'女':'保密')?></td>
         <td align="center" valign="middle" class="borderright borderbottom"><?php echo $v['email']?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo date('Y-m-d H:i:s',$v['addtime'])?></td>
        <td align="center" valign="middle" class="borderbottom">
            <a href="WebUserController.php?cname=edit&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
            <a href="WebUserController.php?cname=del&id=<?php echo $v['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
    <?php endforeach;?>
     <?php endif;?>
    </table></td>
