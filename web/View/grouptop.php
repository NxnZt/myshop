		...
		<div id="header">
			<div class="header_top">
				<div class="w top_nav">
					...
					<ul>
						<li>
						<?php echo empty($_SESSION['user']['user_name'])?'<a href="./login.php" class="lg_re">登录</a><a href="./register.php" class="lg_re">注册</a>':(empty($_SESSION['user']['nick_name'])?'<a href="person.php" class="lg_re">'.$_SESSION['user']['user_name'].'</a>':'<a href="person.php" class="lg_re">'.$_SESSION['user']['nick_name'].'</a>').'<a href="./action.php?a=outlogin" class="lg_re">退出</a>'
						?>
						</li>
